module.exports = {
    ...
    //==================JOIN====================
    joinCategoryLevelProblem_coding : "select S.problem_id, S.answer_status, S.timestamp, C.category_id, P.level from plass_problem_submit S left outer join plass_problem_category C ON S.problem_id = C.problem_id left outer join plass_problems P ON S.problem_id = P.id WHERE user_id = ?",
    ...
    joinCategoryLevelProblem_shortans : "select S.problem_id, S.answer_status, S.timstamp, C.category_id, P.level from plass_problem_shortans_submit S left outer join plass_problem_shortanswer_category C ON S.problem_id = C.problem_id left outer join plass_problem_shortans P ON S.problem_id = P.id where user_id = ?",
